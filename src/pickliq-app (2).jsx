...
const STYLES = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  @media(max-width:700px){
    ...
    .modal-inner{width:100%!important;max-width:100%!important;max-height:95vh!important;border-radius:16px 16px 0 0!important;position:fixed!important;bottom:0!important;top:auto!important;}
  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(10,22,40,0.6)",backdropFilter:"blur(6px)",
      ...
      <div style={{background:C.cardBg,borderRadius:20,padding:32,width:520,maxWidth:"92vw",
        ...
        <div className="r-grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:20}}>
          {ALL_KPIS.map(k=>(
  ...
  <div style={{background:C.navy,position:"sticky",top:0,zIndex:100,
    ...
    <div style={{maxWidth:1200,margin:"0 auto",padding:"0 16px",
      ...
      <div className="nav-scroll" style={{display:"flex",alignItems:"center",
        marginLeft:20,gap:2,flex:1,overflowX:"auto",WebkitOverflowScrolling:"touch"}}>
        {NAV.map(n=>{
          const a=page===n.id;
          return(
            <button key={n.id} className="nav-btn" onClick={()=>setPage(n.id)} style={{
              background:a?C.pickle:"transparent",padding:"7px 12px",borderRadius:8,
              fontSize:13,fontWeight:a?700:500,color:a?C.navy:"#94A3B8",
              letterSpacing:"0.01em",whiteSpace:"nowrap",flexShrink:0
            }}>{n.label}</button>
          );
        })}
      </div>
      {/* DUPR chip — hidden on small screens via inline media trick */}
      <div className="r-hide" style={{display:"flex",alignItems:"center",gap:10,flexShrink:0}}>
...
const Dashboard=({setPage})=>{
  ...
  return(
    <div className="fade-up" className="page-wrap" style={{maxWidth:1140,margin:"0 auto",padding:"32px"}}>
      {/* Header */}
      ...
      {/* KPI strip */}
      <div className="kpi-strip" style={{display:"grid",gridTemplateColumns:`repeat(${kpis.length},1fr)`,gap:14,marginBottom:16}}>
...
const MatchHistoryContent=()=>{
  ...
  return(
    <div>
      ...
      <div className="r-sidebar" style={{display:"grid",gridTemplateColumns:"280px 1fr",gap:20,width:"100%"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:16}}>
          ...
          <Card>
            ...
            <div className="kpi-strip" style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:12,marginBottom:20}}>
      ...
      <div className="r-sidebar" style={{display:"grid",gridTemplateColumns:"280px 1fr",gap:20,width:"100%"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:16}}>
          <Card>
            ...
            <div className="kpi-strip" style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:12}}>
...
const Profile=({setPage})=>{
  ...
  return(
    <div className="fade-up" className="page-wrap" style={{maxWidth:1100,margin:"0 auto",padding:"32px"}}>
      ...
      <div className="r-grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20,marginBottom:20}}>
        <Card>
          <SLabel>Season Stats</SLabel>
          <div className="r-grid-3" style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:12,marginBottom:16}}>
...
const LogMatchContent=()=>{
  ...
  return(
    <div className="page-wrap r-full" style={{maxWidth:760}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:16}}>
        ...
        <Card>
          ...
          <div className="r-grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"0 32px"}}>
            <div>
...
const MatchCenter=()=>{
  ...
  return(
    <div className="fade-up" className="page-wrap" style={{maxWidth:1100,margin:"0 auto",padding:"32px"}}>
      ...
      {/* Tab bar */}
      <div className="tab-bar" style={{display:"flex",gap:4,marginBottom:28,background:C.cardBg,
        border:`1px solid ${C.border}`,borderRadius:14,padding:5,width:"100%",overflowX:"auto"}}>
        {TABS.map(t=>(
          <button key={t.id} onClick={()=>setTab(t.id)} style={{
...
const HelpModal = ({onClose}) => {
  ...
  return(
    <div className="modal-wrap" style={{position:"fixed",inset:0,background:"rgba(10,22,40,0.72)",backdropFilter:"blur(8px)",
      zIndex:400,display:"flex",alignItems:"center",justifyContent:"center",padding:16}}>
      <div className="modal-inner" style={{background:C.cardBg,borderRadius:20,width:"100%",maxWidth:620,
