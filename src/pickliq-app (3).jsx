...
// Responsive page wrapper — collapses padding on mobile
const RWrap = ({children, maxWidth=1100}) => {
...
const RGrid = ({children, cols=2, mCols=1, gap=16, style={}}) => {
  const isMobile = useIsMobile();
  return(
    <div style={{
      display:"grid",
      gridTemplateColumns:`repeat(${isMobile?mCols:cols},1fr)`,
      gap, width:"100%", boxSizing:"border-box", ...style
    }}>
      {children}
    </div>
  );
...
const RSidebar = ({children, sideWidth=280, gap=20}) => {
  const isMobile = useIsMobile();
  return(
    <div style={{
      display:"grid",
      gridTemplateColumns: isMobile ? "1fr" : `${sideWidth}px 1fr`,
...
const Dashboard=({setPage})=>{
  ...
  return(
    <div className="fade-up" style={{width:"100%"}}>
      ...
      {/* KPI strip */}
      <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr 1fr":`repeat(${kpis.length},1fr)`,gap:14,marginBottom:16}}>
