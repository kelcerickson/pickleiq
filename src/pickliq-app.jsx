...
const Dashboard=({setPage})=>{
  ...
  return(
    <div className="fade-up" style={{width:"100%",boxSizing:"border-box",padding:isMobile?"14px 14px 20px":"28px 28px 32px",maxWidth:1200,margin:"0 auto"}}>
      ...
      {/* KPI strip */}
      {isMobile ? (
        <div style={{display:"flex",gap:10,overflowX:"auto",marginBottom:16,WebkitOverflowScrolling:"touch",paddingBottom:4}}>
          {kpis.map(k=><div key={k.id} style={{flexShrink:0,width:140}}><KPICard {...k}/></div>)}
        </div>
      ) : (
