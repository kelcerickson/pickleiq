...
const SUPABASE_KEY = "sb_publishable_OUXDj2oJfU8ZAQ8Xb9fDeA_qeFnzU1t";
...
const Profile=({setPage})=>{
  ...
  const openEdit = () => {
    setDraft({playerName,location,homeClub,email,dupr});
    setShowEditModal(true);
  };
  const saveEdit = async () => {
    setSaving(true);
    try {
      await sb.upsert("profile", {
        id: 1,
      ...
      <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:20,marginBottom:20}}>
        <Card>
          ...
          <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr 1fr",gap:12,marginBottom:16}}>
            <KPICard label="DUPR"      value="—"    color={C.blue}   colorL={C.blueL}/>
            <KPICard label="Win Rate"  value="—"    color={C.mint}   colorL={C.mintL}/>
            <KPICard label="Matches"   value="0"    color={C.amber}  colorL={C.amberL}/>
          </div>
